...
//				.authorizeHttpRequests(auth -> auth.requestMatchers("/user/register", "/user/login").permitAll() // Public
//																													// endpoints
//						.requestMatchers(HttpMethod.GET, "/**").permitAll() // Allow GET requests for all
